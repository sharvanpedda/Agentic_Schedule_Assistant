 ...
 * Currently off per product decision (auto-send after a silence pause was
 * unreliable across browsers/environments) — kept as a flag rather than
 * deleted so it's a one-line flip if that changes later.
 */
...
export default function ChatWidget({
  ...
  const canListen = voiceEnabled && speechSupported();
