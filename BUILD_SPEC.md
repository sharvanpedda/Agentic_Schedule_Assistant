# Schedule Assistant — Build Specification

This spec defines the exact architecture, contracts, and file inventory for building the
**Agentic RAG Schedule Assistant**. Read it fully before writing any code. Build targets:
